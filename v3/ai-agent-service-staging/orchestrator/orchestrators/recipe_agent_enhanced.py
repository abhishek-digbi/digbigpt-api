...
GUIDELINE_MESSAGE = (
    "Prefer recipes with ND Scores of 13 or higher. If you want to see how to improve the ND Score,"
    " or see the ingredients/shopping list, visit the recipe page by clicking the button shown"
)
...
class RecipeAgentEnhanced(AskDigbiBaseAgent):
    ...
    async def get_nutrition_data(
        ...
        for id, recipe in recipes.items():
            try:
                ...
                nutrition_ctx.query = (
                    "Provide improvements to this recipe to improve the nd score."
                    "If the user profile has 'Excluded Ingredients' and the recipe includes some of them"
                    "callout their presence and provide alternatives to them.\n\n"
